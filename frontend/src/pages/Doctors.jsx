  ...
  return (
    <div>
        ...
        <div className='flex flex-col sm:flex-row items-start gap-5 mt'> 
          <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFliter ? 'bg-primary text-white' : ''} `} onClick={()=>setShowFilter(prev => !prev)}>Filters</button>
